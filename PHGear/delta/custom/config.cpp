...
class CfgWeapons
{
	...
	class PHRP_Delta_Armor : PHRP_Base_Armor
	{
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customarmor_deltabase_CO.paa"
		};
	...
	class PHRP_Delta_Medic_Armor : PHRP_Base_Armor
	{
		author = "Project Harvest Mod Team";
		displayName = "M52D Body Armor - Delta Medic";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\legs_base_co.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
			"PHGear\data\armor\customarmor_deltamedic_CO.paa"
		};
		class ItemInfo :ItemInfo
		{
			uniformModel = "\OPTRE_UNSC_Units\Army\armor.p3d";
