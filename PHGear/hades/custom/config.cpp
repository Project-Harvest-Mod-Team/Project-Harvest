...
class CfgWeapons
{
	...
	class PHRP_Payne_M56R_Armor : PHRP_Base_M56R_Armor
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"PHGear\data\armor\payne_H3_Upper_Armor_co.paa",
			"PHGear\data\armor\payne_H3_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Addons\Thigh_Pouch_co.paa",
	...
	class PHRP_Wolf_M56R_Armor : PHRP_Base_M56R_Armor
	{
		scope = 2;
		scopeArsenal = 2;
		author = "Soldner";
		displayName = "[PHRP] M56R Combat Armor (Wolf)";
		hiddenSelections[] = 
		{
			"camo1",
			"camo2",
		...
		hiddenSelectionsTextures[] = 
		{
			...
			"MA_Armor\data\Vests\H3_ODST\Addons\Thigh_Pouch_co.paa",
			"PHGear\data\armor\wolf_Reach_Armor_Upper_co.paa",
			"PHGear\data\armor\wolf_Reach_Armor_Lower_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
			"PHGear\data\armor\wolf_Forearm_Vents_co.paa",
			"PHGear\data\armor\wolf_Sniper_co.paa",
			"PHGear\data\armor\wolf_CQB_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Addons\Reach_Shoulder_Radio\Shoulder_Radio_Green_co.paa"
		};
		class ItemInfo: ItemInfo
		{
	...
	class PHRP_Ramirez_M56R_Armor : PHRP_Base_M56R_Armor
	{
		scope = 2;
		scopeArsenal = 2;
		author = "SirChungus";
		displayName = "[PHRP] M56R Combat Armor (Ramirez)";
		hiddenSelections[] = 
		{
			"camo1",
			"camo2",
		...
		hiddenSelectionsTextures[] = 
		{
			...
			"PHGear\data\armor\onetwo_H3_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Addons\Thigh_Pouch_co.paa",
			"PHGear\data\armor\ramirez_Reach_Upper_Armor_co.paa",
			"PHGear\data\armor\ramirez_Reach_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
			"PHGear\data\armor\ramirez_Forearm_Vents_co.paa",
			"PHGear\data\armor\ramirez_Sniper_co.paa",
			"PHGear\data\armor\ramirez_CQB_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Addons\Reach_Shoulder_Radio\Shoulder_Radio_Green_co.paa"
		};
		class ItemInfo: ItemInfo
		{
