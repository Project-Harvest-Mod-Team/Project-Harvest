...
class CfgWeapons
{
	...
	class PHRP_Erikson_M56R_Armor : PHRP_Base_M56R_Armor
	{
		scope = 2;
		scopeArsenal = 2;
		author = "MrMicrobe";
		displayName = "[PHRP] M56R Combat Armor (Erikson)";
		hiddenSelections[] = 
		{
			"camo1",
			"camo2",
		...
		hiddenSelectionsTextures[] = 
		{
			...
			"PHGear\data\armor\erikson_Reach_Armor_Upper_co.paa",
			"PHGear\data\armor\erikson_Reach_Armor_Lower_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Forearm_Vents_co.paa",
			"PHGear\data\armor\erikson_Sniper_co.paa",
			"PHGear\data\armor\erikson_CQB_co.paa",
