...
class CfgWeapons
{
	...
	class PHRP_onethree_Armor : PHRP_Base_Armor
	{
		author = "Soldner";
		displayName = "M52D Body Armor 1-3";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customarmor_onethreebase_CO.paa"
		};
	...
	class PHRP_onethreemedic_Armor : PHRP_Base_Armor
	{
		author = "Soldner";
		displayName = "M52D Body Armor 1-3 Corpsman";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\legs_base_co.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
			"PHGear\data\armor\customarmor_onethreemedic_CO.paa"
		};
		class ItemInfo :ItemInfo
		{
			uniformModel = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	class PHRP_Coleson_Armor : PHRP_Base_Armor
	{
		...
		hiddenSelectionsTextures[] =
		{
			"PHGear\data\Army\data\vest_odst_co.paa",
			"PHGear\data\army\data\armor_odst_co.paa",
			"PHGear\data\armor\customlegs_coleson_co.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
