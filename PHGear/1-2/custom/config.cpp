...
class CfgWeapons
{
	...
	class PHRP_onetwo_Armor : PHRP_Base_Armor
	{
		author = "Soldner";
		displayName = "M52D Body Armor 1-2";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customarmor_onetwobase_CO.paa"
		};
	...
	class PHRP_onetwomedic_Armor : PHRP_Base_Armor
	{
		author = "Soldner";
		displayName = "M52D Body Armor 1-2 Corpsman";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customlegs_onetwobase_CO.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
			"PHGear\data\armor\customarmor_onetwomedic_CO.paa"
		};
		class ItemInfo :ItemInfo
		{
			uniformModel = "\OPTRE_UNSC_Units\Army\armor.p3d";
