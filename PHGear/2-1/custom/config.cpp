...
class CfgWeapons
{
	...
	class PHRP_twoone_Armor : PHRP_Base_Armor
	{
		author = "Jimbo";
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customlegs_twoonebase_CO.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
			"PHGear\data\armor\customarmor_twoonebase_CO.paa"
		};
	...
	class PHRP_twoonemedic_Armor : PHRP_Base_Armor
	{
		author = "Jimbo";
		displayName = "M52D Body Armor 2-1 Corpsman";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
		...
		hiddenSelectionsTextures[] =
		{
			...
			"PHGear\data\armor\customlegs_twoonebase_CO.paa",
			"PHGear\data\army\data\ghillie_woodland_co.paa",
			"PHGear\data\armor\customarmor_twoonemedic_CO.paa"
		};
		class ItemInfo :ItemInfo
		{
			uniformModel = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	{
		author = "Jimbo";
		displayName = "M52D Body Armor 2-1 (Kaker)";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	{
		author = "MrMicrobe";
		displayName = "M52D Body Armor 2-1 (Wolf)";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	{
		author = "Jimbo";
		displayName = "M52D Body Armor 2-1 (Kincaid)";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	{
		author = "MrMicrobe";
		displayName = "M52D Body Armor 2-1 (Coleson)";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
	...
	{
		author = "Jimbo";
		displayName = "M52D Body Armor 2-1 (Payne)";
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		model = "\OPTRE_UNSC_Units\Army\armor.p3d";
